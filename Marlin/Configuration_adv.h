...
#define AUTOTEMP
  ...
  #define AUTOTEMP_PROPORTIONAL
    ...
    #define AUTOTEMP_FACTOR_P   1.35 // Apply this F parameter by default (overridden by M104/M109 F)
  #endif
#endif
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  50, 20 }, { 215,  20 }, { 215, 215 }, { 50, 215 } }
...
#define LCD_TIMEOUT_TO_STATUS 360000
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  .02       // (steps or mm) Steps or millimeter distance for each Z babystep
 ...
 */
#if ANY(AUTO_BED_LEVELING_3POINT,AUTO_BED_LEVELING_LINEAR,AUTO_BED_LEVELING_BILINEAR)
...
//  #define G29_RECOVER_COMMANDS "M117 Probe failed. Rewiping.\nG28\nG12 P0 S12 T0"
  #define G29_RECOVER_COMMANDS "M117 Probe failed. Retrying.\nG28"
...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  #define MIN_ARC_SEGMENTS       96 // Minimum number of segments in a complete circle
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      375  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     325  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     225  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     225
 ...
 */
#define STARTUP_COMMANDS "M420 L0 S1"
...
#define CUSTOM_USER_MENUS
  ...
  #define CUSTOM_USER_MENU_TITLE "Scripts and Code"
  #define USER_SCRIPT_DONE "M117 Script Finished"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  #define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "Home & Enable Mesh"
  #define USER_GCODE_1 "G28\nM420 L0 S1"

  #define USER_DESC_2 "Go Home"
  #define USER_GCODE_2 "G1 X0 Y0 F5000.0" //Move to start position

  #define USER_DESC_3 "Preheat for " PREHEAT_1_LABEL
  #define USER_GCODE_3 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)

  #define USER_DESC_4 "Preheat for " PREHEAT_2_LABEL
  #define USER_GCODE_4 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)

  #define USER_DESC_5 "G26 Mesh Validation"
  #define USER_GCODE_5 "G26"

  #define USER_DESC_6 "Run Purge Line"
  #define USER_GCODE_6 "G92 E0\nM420 L0 S1\nG1 Z2.0 F3000\nG1 X0.0 Y20 F5000.0\nG1 X0.0 Y20 Z0.3 F5000.0\nG1 X0.0 Y200.0 Z0.3 F1500.0 E15\nG1 X0.3 Y200.0 Z0.3 F5000.0\nG1 X0.3 Y20 Z0.3 F1500.0 E30\nG92 E0\nG1 Z2.0 F3000\nG1 X5 Y20 Z0.3 F5000.0\nG1 X117.5 Y117.5 Z10 F1500.0"

  #define USER_DESC_7 "PID Tune E0"
  #define USER_GCODE_7 "M303 C15 E0 S230 U"

  //#define USER_DESC_7 "PID Tune E1"
  //#define USER_GCODE_7 "M303 C15 E1 S230 U"
#endif
