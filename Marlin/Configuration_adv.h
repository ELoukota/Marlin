...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define EVENT_GCODE_SD_ABORT "M104 S0\nM140 S0\nM106 S0\nG91\nG1 Z10 F1200"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_XY 0.04       // (steps or mm) Steps or millimeter distance for each XY babystep
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     275  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     275
...
#define GCODE_MACROS
  ...
  #define GCODE_MACROS_SLOT_SIZE  75  // Maximum length of a single macro
#endif
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Scripts and Code"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 Script Finished"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Home & Enable Mesh"
  #define MAIN_MENU_ITEM_1_GCODE "G28\nM420 L0 S1"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Go Home"
  #define MAIN_MENU_ITEM_2_GCODE "G1 X0 Y0 F5000.0" //Move to start position
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Preheat for " PREHEAT_1_LABEL
  #define MAIN_MENU_ITEM_3_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
  ...
  #define MAIN_MENU_ITEM_5_DESC "Run Purge Line"
  #define MAIN_MENU_ITEM_5_GCODE "G92 E0\nM420 L0 S1\nG1 Z2.0 F3000\nG1 X0.0 Y20 F5000.0\nG1 X0.0 Y20 Z0.3 F5000.0\nG1 X0.0 Y200.0 Z0.3 F1500.0 E15\nG1 X0.3 Y200.0 Z0.3 F5000.0\nG1 X0.3 Y20 Z0.3 F1500.0 E30\nG92 E0\nG1 Z2.0 F3000\nG1 X5 Y20 Z0.3 F5000.0\nG1 X117.5 Y117.5 Z10 F1500.0"
  //#define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "PID Tune E0 & Save"
  #define MAIN_MENU_ITEM_6_GCODE "M303 C15 E0 S230 U\nM500"
  //#define MAIN_MENU_ITEM_5_CONFIRM
